...
<body>
    <h1>Welcome to Our Game Section!</h1>
</body>
</html>
          <button class="btn-primary" onclick="location.href='our-game.html';">Dimension</button>
...
<body>
    <h1></h1>
    <button class="btn-primary" onclick="location.href='game-center.html';">Game Center</button>
    <button class="btn-secondary" onclick="location.href='https://chrome.google.com/webstore/detail/caret/fljalecfjciodhpcledpamjachpmelml?utm_source=chrome-app-launcher';">Create A Game</button>
    <button class="btn-custom" onclick="location.href='publish-game.html';">Publish Game</button>
